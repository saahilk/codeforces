head>
    ...
    <meta name="X-Csrf-Token" content="cd6d224b1caddd071d06494922917ec6"/>
    ...
    <meta property="og:title" content="Submission #28685387 - Codeforces"/>
    ...
    <title>Submission #28685387 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cd6d224b1caddd071d06494922917ec6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F208%2Fsubmission%2F28685387">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cd6d224b1caddd071d06494922917ec6'/>
...
int main() {
	...
	{
		if(s[i]==&#39;W&#39; and s[i+1]==&#39;U&#39; and s[i+2]==&#39;B&#39;)s[i]=s[i+1]=s[i+2]=&#39;#&#39;,i+=2;
	}
