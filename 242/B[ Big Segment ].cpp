head>
    ...
    <meta name="X-Csrf-Token" content="3d47495564c2d1a2c3592b89376a810e"/>
    ...
    <meta property="og:title" content="Submission #29698396 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d4341dba3b59ac9aa3de6c2173215c05a8e6777a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #29698396 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3d47495564c2d1a2c3592b89376a810e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F242%2Fsubmission%2F29698396">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3d47495564c2d1a2c3592b89376a810e'/>
...
int main()
{
	ll n,i,l,r,al=LLONG_MAX,ar=0;
	cin>>n;
	ll ans=-1;
	for(i=1;i<=n;i++)
	{
		cin>>l>>r;
		if(al>=l and ar<=r)al=l,ar=r,ans=i;
		else if(al>l or ar<r)
		{
			ans=-1;
			if(al>l)al=l;
			if(ar<r)ar=r;
