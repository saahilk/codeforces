head>
    ...
    <meta name="X-Csrf-Token" content="6de12e8e3de9027e965c288de9048fbc"/>
    ...
    <meta property="og:title" content="Submission #28921266 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a01654c98c734890dd096c2d5bbe97fc03650044"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28921266 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6de12e8e3de9027e965c288de9048fbc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F445%2Fsubmission%2F28921266">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6de12e8e3de9027e965c288de9048fbc'/>
...
int main() {
	...
	for(i=0;i<n;i++)
	{
		for(j=0;j<c;j++)
		{
			if(m[i][j]==&#39;.&#39;)
			{
				if((i>0 and m[i-1][j]==&#39;W&#39;) or (j>0 and m[i][j-1]==&#39;W&#39;) or (j<c and m[i][j]==&#39;W&#39;) or (i<n and m[i][j]==&#39;W&#39;))m[i][j]=&#39;B&#39;;
				else if((i>0 and m[i-1][j]==&#39;B&#39;) or (j>0 and m[i][j-1]==&#39;B&#39;) or (j<c and m[i][j]==&#39;B&#39;) or (i<n and m[i][j]==&#39;B&#39;))m[i][j]=&#39;W&#39;;
				else 
				{
					if(i%2==0)
					{
