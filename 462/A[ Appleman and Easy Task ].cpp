head>
    ...
    <meta name="X-Csrf-Token" content="e5ce4c835523af8130a24479bee914f9"/>
    ...
    <meta property="og:title" content="Submission #28712833 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f666f28c4699dbfcf95347102e3b40f955f55f42"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28712833 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e5ce4c835523af8130a24479bee914f9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F462%2Fsubmission%2F28712833">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e5ce4c835523af8130a24479bee914f9'/>
...
int main() {
	...
	for(i=0;i<n;i++)
	{
		...
		{	
				...
				if(i<n-1 and mat[i+1][j]==&#39;o&#39;)ctr++;
				if(i>0 and mat[i-1][j]==&#39;o&#39;)ctr++;
				if(j>0 and mat[i][j-1]==&#39;o&#39;)ctr++;
			if(ctr%2==1)
			{
				fl=1;
				break;
