head>
    ...
    <meta name="X-Csrf-Token" content="006a7706ba9d22d3475aa3771ff46a04"/>
    ...
    <meta property="og:title" content="Submission #27882368 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="ebc2544e180ae2af6fad1905e58924f29ffb5506"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #27882368 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='006a7706ba9d22d3475aa3771ff46a04'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F352%2Fsubmission%2F27882368">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='006a7706ba9d22d3475aa3771ff46a04'/>
...
int main()
{
    ...
    map<ll,vi > m;
    vii ans;
    f(i,0,n)m[a[i]].push_back(i);
    for(auto it=m.begin();it!=m.end();it++)
    {
        siz=(*it).S.size();
        if(siz==1)ans.push_back({(*it).F,0});
        else
        {
            fl=0,dif=(*it).S[1]-(*it).S[0];
            f(i,1,siz)
            {
                if(dif!=(*it).S[i]-(*it).S[i-1])
                {
                    fl=1;
                    break;
                }
