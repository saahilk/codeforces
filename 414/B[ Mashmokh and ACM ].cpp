head>
    ...
    <meta name="X-Csrf-Token" content="b52b57ccdb14e421aa0fde818f62d821"/>
    ...
    <meta property="og:title" content="Submission #32340867 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a3ee9880ac86af5683f0df0d67678a918576ec22"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #32340867 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b52b57ccdb14e421aa0fde818f62d821'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F414%2Fsubmission%2F32340867">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b52b57ccdb14e421aa0fde818f62d821'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/414">Problems</a></li>
        <li><a
                                        href="/contest/414/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/414/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/414/status">Status</a></li>
        <li><a
                                        href="/contest/414/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/414/room/1">Room</a></li>
        <li><a
                                        href="/contest/414/standings">Standings</a></li>
        <li><a
                                        href="/contest/414/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<tr>
    ...
    <td>
            Practice:<br/>
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    <td>
        <a title="B - Mashmokh and ACM" href="/contest/414/problem/B">414B</a>
    ...
    <td>2017-11-15 22:11:59</td>
    <td>2017-11-15 22:12:00</td>
    <td>
...
//   Saahil Kamat   NIT-Calicut 3rd year B.Tech. CSE                                       //
//   user-handle:saahilk (codechef,codeforces)                                             //
//#########################################################################################//
...
#define rf(i,x,l) for(i=x;i>=l;i--)
#define f(i,x,l) for(i=x;i<l;i++)
#define rep(i,x,l) for(i=x;i<=l;i++)
...
ll calc(ll cur,ll k)
{
    ...
    {
        dp[cur][k]=(dp[cur][k]+calc(i,k-1))%mod;
    }
    return dp[cur][k];
}
int main()
{
  ll i,k,j;
   ...
   ll maxi=0;
   f(i,1,n+1)maxi=(maxi+dp[i][k])%mod;
   cout<<maxi<<endl;
  return 0;
}