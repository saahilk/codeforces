head>
    ...
    <meta name="X-Csrf-Token" content="077835102c4dc7efad923aae6f6708cd"/>
    ...
    <meta property="og:title" content="Submission #23993981 - Codeforces"/>
    ...
    <title>Submission #23993981 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='077835102c4dc7efad923aae6f6708cd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F466%2Fsubmission%2F23993981">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='077835102c4dc7efad923aae6f6708cd'/>
...
int main()
{
    ll n,i,j,a[1000000],cnt[1000001]={0},sum,sem=0;
    cin>>n;
    sum=0;
    f(i,1,n+1)
    {
