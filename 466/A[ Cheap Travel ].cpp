head>
    ...
    <meta name="X-Csrf-Token" content="9eba1d9eb097ff7ac611ec3d53965d5b"/>
    ...
    <meta property="og:title" content="Submission #28690084 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="23dfa0f1bc3cc240b0d7679f65ee016fcbb64396"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28690084 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9eba1d9eb097ff7ac611ec3d53965d5b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F466%2Fsubmission%2F28690084">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9eba1d9eb097ff7ac611ec3d53965d5b'/>
...
int main() {
	// your code goes here
	long long a,b,n,m,q,r;
	cin>>n>>m>>a>>b;
	q=n/m;
	r=n%m;
	if(b<=a)
	{
		cout<<(long long int)(ceil((long double)n/m))*b<<endl;
		return 0;
	}
	cout<<min(q*b+r*a,min(n*a,(long long int)(ceil((long double)n/m))*b))<<endl;
	return 0;
}