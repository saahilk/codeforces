head>
    ...
    <meta name="X-Csrf-Token" content="7426b48a4994f364fb5f61c0cdc89f27"/>
    ...
    <meta property="og:title" content="Submission #31609569 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="68542a960fa101c27b1736fb1cbd60359e3308e9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31609569 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7426b48a4994f364fb5f61c0cdc89f27'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F253%2Fsubmission%2F31609569">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7426b48a4994f364fb5f61c0cdc89f27'/>
...
int main()
{
  ...
  f(i,0,n)
  {
  		l=i+(a.end()-(upper_bound(all(a),2*a[i])));
  		if(l<ctr)ctr=l;
  }
  cout<<ctr<<endl;
  return 0;
