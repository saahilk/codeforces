head>
    ...
    <meta name="X-Csrf-Token" content="cea077514732767c0a40e9ce2bce527e"/>
    ...
    <meta property="og:title" content="Submission #29702021 - Codeforces"/>
    ...
    <title>Submission #29702021 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cea077514732767c0a40e9ce2bce527e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F253%2Fsubmission%2F29702021">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cea077514732767c0a40e9ce2bce527e'/>
...
int main()
{
	...
	if(n>m)
	{
		for(i=0;i<min(n,m);i++)cout<<"BG";
		for(i=0;i<abs(n-m);i++)cout<<"B";
		cout<<endl;
	}
	else
	{
		for(i=0;i<min(n,m);i++)cout<<"GB";
		for(i=0;i<abs(n-m);i++)cout<<"G";
		cout<<endl;
	}
	return 0;
}