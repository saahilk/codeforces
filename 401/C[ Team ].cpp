head>
    ...
    <meta name="X-Csrf-Token" content="d3fb2ffcbe80c23bbf184a7f8d7d3f95"/>
    ...
    <meta property="og:title" content="Submission #24228247 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d3285bd808b453c0825b8e4c1439aca8df28ea72"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #24228247 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d3fb2ffcbe80c23bbf184a7f8d7d3f95'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F401%2Fsubmission%2F24228247">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d3fb2ffcbe80c23bbf184a7f8d7d3f95'/>
...
int main()
{
   ll int m,n,i,num,ul,lol;
   cin>>n>>m;
    lol=ceil((float)m/2)-1;
    ul=m+1;
    if(n<lol or n>ul)cout<<-1<<endl;
    else
    {
        if(ul==n)
        {
