head>
    ...
    <meta name="X-Csrf-Token" content="8687621051cbf94dfbb108d77feffddd"/>
    ...
    <meta property="og:title" content="Submission #31550190 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="6ed5f857c1c22ccbf1732497ddff2cff9feba094"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31550190 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8687621051cbf94dfbb108d77feffddd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F166%2Fsubmission%2F31550190">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8687621051cbf94dfbb108d77feffddd'/>
...
{
  fast
  int n,k,i,y,z,ctr,rank;
  cin>>n>>k;
  vii a;
  f(i,0,n)
  {
  	cin>>y>>z;
  	a.push_back(make_pair(y,z));
  }
  sort(a.begin(),a.end(),[](const auto &lhs,const auto &rhs){
  		if(lhs.F>rhs.F)return true;
  		else if(lhs.F==rhs.F)return lhs.S<rhs.S;
  		else return false;
  });
  ctr=0;
  rank=1;
  for(i=0;i<n;i++)if(a[i]==a[k-1])ctr++;
  cout<<ctr<<endl;
