head>
    ...
    <meta name="X-Csrf-Token" content="44ced7a0960b5fcd4de28a239190d911"/>
    ...
    <meta property="og:title" content="Submission #31514453 - Codeforces"/>
    ...
    <title>Submission #31514453 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='44ced7a0960b5fcd4de28a239190d911'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F166%2Fsubmission%2F31514453">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='44ced7a0960b5fcd4de28a239190d911'/>
...
int main() {
	...
	else
	{
		...
		l++;
//cout<<l<<endl;
		if(n-l==l)cout<<1<<endl;
		else if(l>n-l)cout<<2*l-n+1<<endl;
		else cout<<abs(n-2*l)<<endl;
	}
