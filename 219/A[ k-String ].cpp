head>
    ...
    <meta name="X-Csrf-Token" content="b24c0982b89b6487fafa02e26e7aab04"/>
    ...
    <meta property="og:title" content="Submission #29704020 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="65679ecbcedd476f61db647ee3fa3491543f603c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #29704020 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b24c0982b89b6487fafa02e26e7aab04'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F219%2Fsubmission%2F29704020">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b24c0982b89b6487fafa02e26e7aab04'/>
...
int main()
{
	...
	for(auto p:m)
	{
			for(i=0;i<p.second/k;i++)
			{
				c+=p.first;
			}
	}
	for(i=0;i<k;i++)cout<<c;
	cout<<endl;
	return 0;
}