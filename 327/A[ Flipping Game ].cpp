head>
    ...
    <meta name="X-Csrf-Token" content="cddc38f717db804eb96d9dc64033f907"/>
    ...
    <meta property="og:title" content="Submission #28901577 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="b1017fc49146a64a346f4b25d017c84effd77b3c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28901577 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cddc38f717db804eb96d9dc64033f907'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F327%2Fsubmission%2F28901577">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cddc38f717db804eb96d9dc64033f907'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    ...
    <td>2017-07-26 13:49:17</td>
    <td>2017-07-26 13:49:40</td>
    <td>
...
int main() {
	// your code goes here
	int n,maxi,i,x,ones,posr,pos=0,zer,l,r;
	cin>>n;
	vector<int> v(n);
	maxi=ones=zer=0,l=0,r=0,posr=0;
	for(i=0;i<n;i++)
	{
		cin>>x;
		v[i]=x;
		...
		if(zer>maxi)maxi=zer,pos=l,posr=r;
	}
	for(i=pos;i<posr;i++)
	{
		v[i]=1-v[i];
