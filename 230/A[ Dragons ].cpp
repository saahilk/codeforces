head>
    ...
    <meta name="X-Csrf-Token" content="ee302ba2047fcb24fb4c58b73338f847"/>
    ...
    <meta property="og:title" content="Submission #28696648 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d068d845f7b6d561328491a4b667eab1da14e583"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28696648 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ee302ba2047fcb24fb4c58b73338f847'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F230%2Fsubmission%2F28696648">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ee302ba2047fcb24fb4c58b73338f847'/>
...
int main() {
	...
	int s,n,i;
	cin>>s>>n;
	vector<struct drag> d(n);
	for(i=0;i<n;i++)
	{
		cin>>d[i].s>>d[i].b;
	}
	sort(d.begin(),d.end(),[] (const auto &lhs,const auto &rhs){
		return lhs.s<rhs.s;
	});
	for(i=0;i<n;i++)
	{
