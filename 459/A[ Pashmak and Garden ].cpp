head>
    ...
    <meta name="X-Csrf-Token" content="bc3c657e9acffd3734961e4c4e84ac2a"/>
    ...
    <meta property="og:title" content="Submission #28693861 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="00d7423fc454367a592656d688b539f1d814a295"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28693861 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bc3c657e9acffd3734961e4c4e84ac2a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F28693861">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bc3c657e9acffd3734961e4c4e84ac2a'/>
...
int main() {
	// your code goes here
	int x1,y1,x2,y2,edge;
	cin>>x1>>y1>>x2>>y2;
	edge=max(fabs(x1-x2),fabs(y1-y2));
	if(x1==x2)
	{
		printf("%d %d %d %d\n",x1+edge,y1,x2+edge,y2);
	}
	else if(y1==y2)
	{
		printf("%d %d %d %d\n",x1,y1+edge,x2,y2+edge);
	}
	else 
	{
