head>
    ...
    <meta name="X-Csrf-Token" content="bda1e06fff995631f60fba6a12ca19b2"/>
    ...
    <meta property="og:title" content="Submission #31517312 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="31afe986d2057a25c124a46aeecaec38c1cdc7b3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31517312 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bda1e06fff995631f60fba6a12ca19b2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F165%2Fsubmission%2F31517312">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bda1e06fff995631f60fba6a12ca19b2'/>
...
int main() {
	// your code goes here
	long long int l,r,i,ans,fl=0,n,ctr,cz,zer,k;
	string s;
	cin>>k;
	cin>>s;
	l=0;
	...
	for(i=0;i<n;)
	{
		...
		while(ctr==k and s[i]==&#39;0&#39; and i<n)i++,zer++;
		if(ctr==k)ans+=(cz+1)*(zer+1);
		
		//cout<<cz<<" "<<zer<<ans<<endl;
		l++;
