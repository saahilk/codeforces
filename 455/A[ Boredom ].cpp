head>
    ...
    <meta name="X-Csrf-Token" content="fecdba5f5703007518ce2a4e1a23a65c"/>
    ...
    <meta property="og:title" content="Submission #27881332 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="bed89538678667173665f4325454d4b4397dfd85"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #27881332 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fecdba5f5703007518ce2a4e1a23a65c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F455%2Fsubmission%2F27881332">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fecdba5f5703007518ce2a4e1a23a65c'/>
...
int main()
{
	...
	f(i,2,100001)a[i]=max(a[i-1],a[i]*i+a[i-2]);
	cout<<a[100000]<<endl;
