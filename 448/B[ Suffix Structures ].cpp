head>
    ...
    <meta name="X-Csrf-Token" content="bc8dd91821770980b6077fd30d389791"/>
    ...
    <meta property="og:title" content="Submission #22946409 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dead3ad3c0cbb5c59296da923b178731cf387485"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #22946409 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bc8dd91821770980b6077fd30d389791'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F448%2Fsubmission%2F22946409">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bc8dd91821770980b6077fd30d389791'/>
...
using namespace std;
string s,t;map<char,int> S,T;int i,j;
main(){
  cin>>s>>t;
  for(char c:s)++S[c];
  for(char c:t)++T[c];
