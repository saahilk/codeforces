head>
    ...
    <meta name="X-Csrf-Token" content="8d592a734e6058745cc758d643f823a7"/>
    ...
    <meta property="og:title" content="Submission #26664880 - Codeforces"/>
    ...
    <title>Submission #26664880 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8d592a734e6058745cc758d643f823a7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F34%2Fsubmission%2F26664880">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8d592a734e6058745cc758d643f823a7'/>
...
int main()
{
	...
	sort(v.begin(),v.end());
	ll ans=0;
	for(i=0;i<m and i<v.size();i++)ans+=fabs(v[i]);
	cout<<ans<<endl;
	return 0;
}