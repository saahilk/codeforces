head>
    ...
    <meta name="X-Csrf-Token" content="6655bbf9eb491ca250cc5e712349d3f2"/>
    ...
    <meta property="og:title" content="Submission #28779035 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="cbf12c065b415ca9d862e8b0d48a47592a55ca08"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28779035 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6655bbf9eb491ca250cc5e712349d3f2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F34%2Fsubmission%2F28779035">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6655bbf9eb491ca250cc5e712349d3f2'/>
...
int main() {
	...
	for(i=0;i<n;i++)
	{
		if(abs(a[i]-a[(i+1)%n])<mini)mini=abs(a[i]-a[(i+1)%n]),pos=i;
	}
