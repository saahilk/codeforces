head>
    ...
    <meta name="X-Csrf-Token" content="aea3ffeb5876fcc38eb285bd5291ca21"/>
    ...
    <meta property="og:title" content="Submission #28674426 - Codeforces"/>
    ...
    <title>Submission #28674426 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='aea3ffeb5876fcc38eb285bd5291ca21'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F339%2Fsubmission%2F28674426">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='aea3ffeb5876fcc38eb285bd5291ca21'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    ...
    <pre class="prettyprint lang-py program-source" style="padding: 0.5em;"># your code goes here
l=[int(x) for x in input().split(&#39;+&#39;)]
l.sort()
ans=[str(x) for x in l]
y=str.join(&#39;+&#39;,ans)
print(y)