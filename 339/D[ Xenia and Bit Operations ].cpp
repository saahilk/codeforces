head>
    ...
    <meta name="X-Csrf-Token" content="d047c29ea32b21df28cdf7297d376ffc"/>
    ...
    <meta property="og:title" content="Submission #32347569 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e470dadd85a8502e54e4a7e2be97d6a47b32e560"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #32347569 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d047c29ea32b21df28cdf7297d376ffc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F339%2Fsubmission%2F32347569">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d047c29ea32b21df28cdf7297d376ffc'/>
...
void build(ll l,ll r,ll root)
{
    ...
    {
        ll mid=getmid(l,r);
        build(l,mid,2*root+1);
        build(mid+1,r,2*root+2);
        op[root]=!op[2*root+1];
        if(op[root])
        {
            s[root]=s[2*root+1]|s[2*root+2];
        }
        else
        {
            s[root]=s[2*root+1]^s[2*root+2];
...
ll up(ll l,ll r,ll p,ll b,ll root)
{
    if(p>=l and p<=r)
    {
        if(l==r)
        {
          return a[root]=s[root]=b;
        }
        else
        {
          ll mid=getmid(l,r);
          if(op[root])
          {
             s[root]=up(l,mid,p,b,2*root+1)|up(mid+1,r,p,b,2*root+2);
          }
          else
          {
             s[root]=up(l,mid,p,b,2*root+1)^up(mid+1,r,p,b,2*root+2);
