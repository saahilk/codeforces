head>
    ...
    <meta name="X-Csrf-Token" content="f20a17a61bc851fcb3650a44a3aef13b"/>
    ...
    <meta property="og:title" content="Submission #28780061 - Codeforces"/>
    ...
    <title>Submission #28780061 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f20a17a61bc851fcb3650a44a3aef13b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F353%2Fsubmission%2F28780061">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f20a17a61bc851fcb3650a44a3aef13b'/>
...
int main() {
	...
	for(i=0;i<n;i++)
	{
		...
		else if(x%2==1 and y%2==0)c++;
	}

	if(a%2==0)
	{
		if(b%2==0 and c%2==0)cout<<0<<endl;
		else if(b%2==1 and c%2==1)cout<<1<<endl;
		else cout<<-1<<endl;
	}
	else
	{
		if(b==0 and c==0)cout<<-1<<endl;
		else if(b%2==1 and c%2==1)cout<<0<<endl;
		else if(b%2==0 and c%2==0)cout<<1<<endl;
		else cout<<-1<<endl;
	}
	return 0;
}