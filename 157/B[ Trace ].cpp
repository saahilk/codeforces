head>
    ...
    <meta name="X-Csrf-Token" content="a56f53a030d3ea82a914108a8e658f21"/>
    ...
    <meta property="og:title" content="Submission #26662385 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="568b1cf0c61669a2db9ad27a59646543ae339c9e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #26662385 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a56f53a030d3ea82a914108a8e658f21'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F157%2Fsubmission%2F26662385">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a56f53a030d3ea82a914108a8e658f21'/>
...
int main()
{
	...
	for(i=n-1;i>=0;i-=2)
	{
		if(i==0)sum+=pow(a[i],2);
		else sum+=pow(a[i],2)-pow(a[i-1],2);
	}
	cout<<(long double)sum*3.1415926<<endl;
	return 0;
}