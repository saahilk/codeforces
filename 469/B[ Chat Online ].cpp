head>
    ...
    <meta name="X-Csrf-Token" content="584c78bedc3976ad88fc78cca029b02f"/>
    ...
    <meta property="og:title" content="Submission #23248896 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dcd8ebf3e85abd6648e5674c52f04b8a65eaa248"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #23248896 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='584c78bedc3976ad88fc78cca029b02f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F469%2Fsubmission%2F23248896">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='584c78bedc3976ad88fc78cca029b02f'/>
...
int main()
{
    ...
    int p,q,l,r,a,i,b,ctr=0,posx,posz;
    vector< pii > x,z;
    cin>>p>>q>>l>>r;
    bool flag;
    f(i,0,p){
    ...
    f(i,l,r+1)
    {
        flag=0,posx=0,posz=0;
        while(posx<x.size()&&posz<z.size())
        {
            if(x[posx].first<z[posz].first+i&&x[posx].second<z[posz].first+i)
                posx++;
            else if(x[posx].first>z[posz].second+i&&x[posx].second>z[posz].second+i)
                posz++;
            else
            {
                flag=1;
