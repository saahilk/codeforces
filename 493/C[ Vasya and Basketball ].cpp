head>
    ...
    <meta name="X-Csrf-Token" content="675df86ab38683076e4d76e6fd53bf93"/>
    ...
    <meta property="og:title" content="Submission #31732160 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="0610c1e155b6961327b2aeeb7e73828c98c30329"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31732160 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='675df86ab38683076e4d76e6fd53bf93'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F493%2Fsubmission%2F31732160">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='675df86ab38683076e4d76e6fd53bf93'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    <td>
        <a title="C - Vasya and Basketball" href="/contest/493/problem/C">493C</a>
...
int main()
{
  ...
  sort(all(a));
  sort(all(b));
  ll maxi=LLONG_MIN,y,z;
  i=0;
  x=b.end()-upper_bound(all(b),a[i]-1);
  dif=(3*(n))-(3*x+2*(m-x));
  //cout<<x<<endl;
  if(maxi<dif)maxi=dif,y=3*n,z=(3*x+2*(m-x));
  if(maxi<2*(n-m))maxi=dif,y=2*n,z=2*m;


  for(i=0;i<n;)
  {
      while(i+1<n and a[i]==a[i+1])i++;
      x=b.end()-upper_bound(all(b),a[i]);
      dif=((i+1)*2+3*(n-i-1))-(3*x+2*(m-x));
      if(maxi<dif)maxi=dif,y=((i+1)*2+3*(n-i-1)),z=(3*x+2*(m-x));
      i++;
  }
  for(i=0;i<m;)
  {
      while(i+1<m and b[i]==b[i+1])i++;
      x=a.end()-upper_bound(all(a),b[i]);
      dif=(3*x+2*(n-x))-((i+1)*2+3*(m-i-1));
      if(maxi<dif)maxi=dif,z=((i+1)*2+3*(m-i-1)),y=(3*x+2*(n-x));
      i++;
  }
  cout<<y<<":"<<z<<endl;
  return 0;  
