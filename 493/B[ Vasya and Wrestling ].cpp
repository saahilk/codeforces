head>
    ...
    <meta name="X-Csrf-Token" content="a14f7aeee8c6e3ebc02587166fc7666d"/>
    ...
    <meta property="og:title" content="Submission #23338531 - Codeforces"/>
    ...
    <title>Submission #23338531 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a14f7aeee8c6e3ebc02587166fc7666d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F493%2Fsubmission%2F23338531">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a14f7aeee8c6e3ebc02587166fc7666d'/>
...
list<l> k[2];
main(){
    for(cin>>n;n--;)cin>>b,c=b<0,b=abs(b),a[c]+=b,k[c].push_back(b);
    k[0].push_front(a[0]);
    k[1].push_front(a[1]);
    if(k[0]==k[1])k[c].push_back(1);
