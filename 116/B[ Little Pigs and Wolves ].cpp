head>
    ...
    <meta name="X-Csrf-Token" content="1fc51d6817ce15739d0d3a097f3c38f8"/>
    ...
    <meta property="og:title" content="Submission #26753088 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e0166691d9b2c8d6f1f0eb736ea48a047395fee4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #26753088 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1fc51d6817ce15739d0d3a097f3c38f8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F116%2Fsubmission%2F26753088">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1fc51d6817ce15739d0d3a097f3c38f8'/>
...
int main()
{
	...
	f(i,0,n)
	{
		f(j,0,m)
		{
			if(a[i][j]==&#39;W&#39;)
			{
				if(i>0 and a[i-1][j]==&#39;P&#39;)ctr++;
				else if(i<n-1 and a[i+1][j]==&#39;P&#39;)ctr++;
				else if(j>0 and a[i][j-1]==&#39;P&#39;)ctr++;
				else if(j<m-1 and a[i][j+1]==&#39;P&#39;)ctr++;
			}
		}
	}
	cout<<ctr<<endl;
