head>
    ...
    <meta name="X-Csrf-Token" content="81ceaa85c13d4642929284cec5bead70"/>
    ...
    <meta property="og:title" content="Submission #28730066 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="ea49bc93c55050a5a4b6586f6158f42261f3faee"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28730066 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='81ceaa85c13d4642929284cec5bead70'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F496%2Fsubmission%2F28730066">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='81ceaa85c13d4642929284cec5bead70'/>
...
int main()
{
	...
	for(i=2;i<n;i++)
	{
		if(a[i]-a[i-2]<m)m=a[i]-a[i-2],pos=i;
	}
