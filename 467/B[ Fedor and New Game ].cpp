head>
    ...
    <meta name="X-Csrf-Token" content="cbe7114a9e1a1247c746f9d18c3662ff"/>
    ...
    <meta property="og:title" content="Submission #22878139 - Codeforces"/>
    ...
    <title>Submission #22878139 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cbe7114a9e1a1247c746f9d18c3662ff'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F467%2Fsubmission%2F22878139">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cbe7114a9e1a1247c746f9d18c3662ff'/>
...
int main()
{
    long long int n,m,k,ctr,mc=0,i,q,r;
    bool flag;
    cin>>n>>m>>k;
    long long int a[m+1];
    for(i=0;i<=m;i++)
