head>
    ...
    <meta name="X-Csrf-Token" content="29cdb8e144511d8e7934a2fdbd38e768"/>
    ...
    <meta property="og:title" content="Submission #30567408 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="156eda7030bf516fd7eb2ae3da70a05291c8dca8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #30567408 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='29cdb8e144511d8e7934a2fdbd38e768'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F467%2Fsubmission%2F30567408">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='29cdb8e144511d8e7934a2fdbd38e768'/>
...
ll calc(ll cur,ll k)
{
	...
	mat[cur][k]=max(calc(cur+1,k),calc(cur+m,k-1)+dp[cur]);
	return mat[cur][k];
}
...
int main()
{
	...
	for(i=0;i<n+1;i++)for(j=0;j<n+1;j++)mat[i][j]=-1;
	ll sum=0;
