head>
    ...
    <meta name="X-Csrf-Token" content="0bfe4021e1acb43ed6a2d5978ffdaf3a"/>
    ...
    <meta property="og:title" content="Submission #31516057 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="fca900707d84d4fba237b517e7d694346194144e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31516057 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0bfe4021e1acb43ed6a2d5978ffdaf3a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F31516057">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0bfe4021e1acb43ed6a2d5978ffdaf3a'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    ...
    <td>2017-10-19 21:09:45</td>
    <td>2017-10-19 21:09:46</td>
    <td>
...
int main() {
	...
	sort(v.begin(),v.end());
	ans=0;
	for(i=0;i<n,sum<avg*n;i++)
	{
	
		if(avg*n-sum<=r-v[i].second)
		{
			
			ans+=(avg*n-sum)*v[i].first;
			sum=avg*n;
		}
		else
		{
			sum+=r-v[i].second;
			ans+=(r-v[i].second)*v[i].first;
		}
		//cout<<sum<<" "<<ans<<endl;
	}
	cout<<ans<<endl;
