head>
    ...
    <meta name="X-Csrf-Token" content="48bdfacb5bdb6dbd539986e9ead2b074"/>
    ...
    <meta property="og:title" content="Submission #22882326 - Codeforces"/>
    ...
    <title>Submission #22882326 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='48bdfacb5bdb6dbd539986e9ead2b074'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F22882326">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='48bdfacb5bdb6dbd539986e9ead2b074'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    ...
    <td>2016-12-11 17:40:50</td>
    <td>2016-12-11 17:40:51</td>
    <td>
...
int main()
{
    ...
    cout<<std::fixed<<setprecision(9)<<(double)res/2<<endl;
    return 0;
}
