head>
    ...
    <meta name="X-Csrf-Token" content="e1206912645d39cca7603c0b13eb9d1e"/>
    ...
    <meta property="og:title" content="Submission #23044309 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="9f00e8fb7296b54acf484b79cd22995a3114bdbd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #23044309 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e1206912645d39cca7603c0b13eb9d1e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F279%2Fsubmission%2F23044309">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e1206912645d39cca7603c0b13eb9d1e'/>
...
int main()
{
    ...
    int longest=0,sum=a[0];i=0;
        ...
        //cout<<longest;
        for(i=1;i<n-longest;i++)
        {
            sum-=a[i-1]-a[i+longest];
            //cout<<sum<<endl;
            j=i+longest;
            while(sum<=t&&j<n)
            {
