head>
    ...
    <meta name="X-Csrf-Token" content="6f0bc5cd14e4293c9580c056fa63d51f"/>
    ...
    <meta property="og:title" content="Submission #28727162 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="4c058ad2fcb3723257e3114a146c1793de86b3b9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28727162 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6f0bc5cd14e4293c9580c056fa63d51f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F385%2Fsubmission%2F28727162">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6f0bc5cd14e4293c9580c056fa63d51f'/>
...
int main() {
	...
	for(i=0;i<n-1;i++)
	{
		if(v[i]-v[i+1]-c>=m)m=v[i]-v[i+1]-c;
	}
	if(m>=0)cout<<m<<endl;
	else cout<<0<<endl;
	return 0;
