head>
    ...
    <meta name="X-Csrf-Token" content="d80b8249ccee9e0304378d7fb982fa1e"/>
    ...
    <meta property="og:title" content="Submission #32337095 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f777bbb71bac2600959faf77c3897193065df79e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #32337095 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d80b8249ccee9e0304378d7fb982fa1e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F217%2Fsubmission%2F32337095">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d80b8249ccee9e0304378d7fb982fa1e'/>
...
void dfs(ll x)
{
    ...
    f(i,0,n)
    {
       if(!vis[i] and (a[i]==a[x] or b[i]==b[x]))dfs(i);
    }
}
