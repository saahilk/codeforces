head>
    ...
    <meta name="X-Csrf-Token" content="0ca4ec04fd02b8414114f8cd620c2bbf"/>
    ...
    <meta property="og:title" content="Submission #28761783 - Codeforces"/>
    ...
    <title>Submission #28761783 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0ca4ec04fd02b8414114f8cd620c2bbf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F450%2Fsubmission%2F28761783">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0ca4ec04fd02b8414114f8cd620c2bbf'/>
...
int main() {
	...
	{
		cin>>x;
		if(ceil(x/m)>=maxi)maxi=ceil(x/m),pos=i;
	}
	cout<<pos+1<<endl;
	return 0;
}