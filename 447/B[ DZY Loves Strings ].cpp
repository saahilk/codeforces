head>
    ...
    <meta name="X-Csrf-Token" content="1cfef253433e8fc35207fa30f39ee133"/>
    ...
    <meta property="og:title" content="Submission #22909706 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="980dc52fb078f2c0765e3c35b82ecb90a4be5270"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #22909706 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1cfef253433e8fc35207fa30f39ee133'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F447%2Fsubmission%2F22909706">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1cfef253433e8fc35207fa30f39ee133'/>
...
int main()
{
    ...
    {
        sum+=val[(int)(s[i-1]-&#39;a&#39;)]*i;
    }
    sort(val,val+26);
    for(i=1;i<=k;i++)
    {
        sum+=val[25]*(s.length()+i);
    }
    cout<<sum<<endl;
}
