head>
    ...
    <meta name="X-Csrf-Token" content="08bd0a617687f8a7e72319386843c01e"/>
...
<body><span style='display:none;' class='csrf-token' data-csrf='08bd0a617687f8a7e72319386843c01e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='08bd0a617687f8a7e72319386843c01e'/>
