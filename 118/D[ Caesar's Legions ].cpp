head>
    ...
    <meta name="X-Csrf-Token" content="139d03171d278a7d3ff0ee0d467a60f2"/>
    ...
    <meta property="og:title" content="Submission #32345454 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="7c8adb97526f27a46ba954a628c01fe7a2edb953"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #32345454 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='139d03171d278a7d3ff0ee0d467a60f2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F118%2Fsubmission%2F32345454">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='139d03171d278a7d3ff0ee0d467a60f2'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    ...
    <td>2017-11-16 06:44:59</td>
    <td>2017-11-16 06:45:00</td>
    <td>
...
ll k1,k2,m=100000000;
ll ans=0;
ll dp[102][102][2];

ll calc(ll n1,ll n2,ll type)
{
    ll i;
    if(type==0)
    {
        ...
        if(dp[n1][n2][type]!=-1)return dp[n1][n2][type];
        dp[n1][n2][type]=0;
        f(i,1,min(k1,n1)+1)
        {
            dp[n1][n2][type]=(dp[n1][n2][type]+calc(n1-i,n2,1))%m;
        }
    ...
    f(i,1,min(k2,n2)+1)
    {
        dp[n1][n2][type]=(dp[n1][n2][type]+calc(n1,n2-i,0))%m;
    }
    return dp[n1][n2][type];
...
int main()
{
  ll n1,n2,i,j,k;
  cin>>n1>>n2>>k1>>k2;
  f(i,0,n1+1)f(j,0,n2+1)f(k,0,2)dp[i][j][k]=-1;
  dp[n1][n2][0]=calc(n1,n2,0);
  dp[n1][n2][1]=calc(n1,n2,1);
