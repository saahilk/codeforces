head>
    ...
    <meta name="X-Csrf-Token" content="c26bb39b0d1322a32287eee73f68ad03"/>
    ...
    <meta property="og:title" content="Submission #28779131 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="302b377a6381d74c216c25900130b0027b3e2863"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28779131 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c26bb39b0d1322a32287eee73f68ad03'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F205%2Fsubmission%2F28779131">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c26bb39b0d1322a32287eee73f68ad03'/>
...
int main() {
	// your code goes here
	int n,i,fl=0,mini=INT_MAX,x,pos;
	cin>>n;
	for(i=0;i<n;i++)
	{
		cin>>x;
		if(mini>x)mini=x,fl=0,pos=i;
		else if(mini==x)fl=1;
	}
	if(fl==0)cout<<pos+1<<endl;
