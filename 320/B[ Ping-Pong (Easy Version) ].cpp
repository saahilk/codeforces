head>
    ...
    <meta name="X-Csrf-Token" content="8f5e11a164f495f8c431260e980de28a"/>
    ...
    <meta property="og:title" content="Submission #32353640 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a837498d8031ec5cec5fc54734c0b1ca9e8f7e6b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #32353640 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8f5e11a164f495f8c431260e980de28a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F320%2Fsubmission%2F32353640">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8f5e11a164f495f8c431260e980de28a'/>
...
int main()
{
  ...
  f(i,0,q-1)
  {
      ...
      if(ch==1)
      {
         ...
         f(j,0,n-1)
         {
            if(((ver[j].x<a and a<ver[j].y) or (ver[j].x<b and b<ver[j].y)))
            {
                  ad[n-1].pb(j);
            }
            if((ver[j].x>a and b>ver[j].x) or (ver[j].y>a and b>ver[j].y))
            {
                  ad[j].pb(n-1);
            }
         }
