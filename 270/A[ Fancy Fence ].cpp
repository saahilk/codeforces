head>
    ...
    <meta name="X-Csrf-Token" content="b689168597fb8d9fd6e424ee34f97ac3"/>
    ...
    <meta property="og:title" content="Submission #29367230 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="6c7daa8b6012fc1996d8e2fe345bc47e37d7a2b4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #29367230 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b689168597fb8d9fd6e424ee34f97ac3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F270%2Fsubmission%2F29367230">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b689168597fb8d9fd6e424ee34f97ac3'/>
...
int main() {
	// your code goes here
	ll int n,t,i,ang,cur=3,ans=0,prev=0;
	cin>>t;
	vi a;
	while(1)
	{
	...
	a.pb(179);
	//f(i,0,a.size())cout<<i+3<<" "<<a[i]<<endl;
	f(i,0,t)
	{	
