head>
    ...
    <meta name="X-Csrf-Token" content="1c42c2f8b63b1097ee058a2f94fd657d"/>
    ...
    <meta property="og:title" content="Submission #31538731 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="fa474ed3f19a9426dd00d2358963c7768e461391"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #31538731 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1c42c2f8b63b1097ee058a2f94fd657d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F486%2Fsubmission%2F31538731">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1c42c2f8b63b1097ee058a2f94fd657d'/>
...
ll calc(ll le,ll ri)
{
	...
	while(i<=ri)
	{
		if(s[i]!=s[len-i-1])r=i;
		i++;
	}
	r=r-p+1;
	
	return max(l,r)+2*(min(l,r)-1)+2;
}
...
int main() {
	...
	for(i=0;i<=(len-1)/2;i++)
	{
		if(s[i]!=s[len-i-1])
		{
			ans+=min(abs(s[i]-s[len-i-1]),26-abs(s[i]-s[len-i-1]));
		}
	}
	//cout<<ans<<endl;
	if(p-1<=(len-1)/2)ans+=calc(0,(len-1)/2);
	else ans+=calc((len)/2,len-1);
	cout<<ans<<endl;
	return 0;
}
