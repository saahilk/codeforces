head>
    ...
    <meta name="X-Csrf-Token" content="430b70bb6588338190657f5ee4237254"/>
    ...
    <meta property="og:title" content="Submission #28728128 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="1f86abd44255a0633cefad815cba83f5619345d4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28728128 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='430b70bb6588338190657f5ee4237254'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F151%2Fsubmission%2F28728128">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='430b70bb6588338190657f5ee4237254'/>
...
{
    	// your code goes here
	int n,k,l,c,d,p,nl,np,dr,lm,sa;
	cin>>n>>k>>l>>c>>d>>p>>nl>>np;
	dr=(k*l)/nl;
	lm=c*d;
	sa=p/np;
	cout<<min(dr,min(lm,sa))/n;
	return 0;
}   