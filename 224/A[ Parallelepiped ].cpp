head>
    ...
    <meta name="X-Csrf-Token" content="bd620f367926fd61ba2071e1e371b4f3"/>
    ...
    <meta property="og:title" content="Submission #28769229 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="9ba44fb265cf259e5a418271c6fd39f629b408c7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28769229 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bd620f367926fd61ba2071e1e371b4f3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F224%2Fsubmission%2F28769229">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bd620f367926fd61ba2071e1e371b4f3'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/224">Problems</a></li>
        <li><a
                                        href="/contest/224/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/224/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/224/status">Status</a></li>
        <li><a
                                        href="/contest/224/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/224/room/1">Room</a></li>
        <li><a
                                        href="/contest/224/standings">Standings</a></li>
        <li><a
                                        href="/contest/224/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    <td>
        <a title="A - Parallelepiped" href="/contest/224/problem/A">224A</a>
...
int main() {
	...
	for(i=1;i<=sqrt(v[0]);i++)
	{
		if(v[0]%i==0)
		{
			l=i;
			b=v[0]/l;
			if(v[1]%l==0 and v[2]%b==0 and (v[1]/l==v[2]/b))
			{
				cout<<4*(l+b+v[1]/l)<<endl;
				return 0;
			}
			if(v[1]%b==0 and v[2]%l==0 and (v[2]/l==v[1]/b))
			{
				cout<<4*(l+b+v[1]/b)<<endl;
				return 0;
			}
		}
	}
