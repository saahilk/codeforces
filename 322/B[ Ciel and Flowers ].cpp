head>
    ...
    <meta name="X-Csrf-Token" content="f8ee738b53e226b028c47d8c834217cd"/>
    ...
    <meta property="og:title" content="Submission #29857897 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a7a2f3b360f6362874078d07041a23dba52b5e7a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #29857897 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f8ee738b53e226b028c47d8c834217cd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F322%2Fsubmission%2F29857897">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f8ee738b53e226b028c47d8c834217cd'/>
...
<a href="/profile/saahilk" title="Specialist saahilk" class="rated-user user-cyan">saahilk</a>    </td>
    <td>
        <a title="B - Ciel and Flowers" href="/contest/322/problem/B">322B</a>
...
int main()
{
	ll r,g,bl,a,b,c,ans=-1;
	cin>>r>>g>>bl;
	a=r%3,b=g%3,c=bl%3;
	if(min(r,min(g,bl))==0)
	{
		cout<<r/3+g/3+bl/3<<endl;
		return 0;
	}
	if((a==2 and b==2 and c!=2) or (a!=2 and b==2 and c==2) or (a==2 and b!=2 and c==2))
	{
		ans=r/3+g/3+bl/3+1;
	}
	cout<<max(ans,r/3+g/3+bl/3+min(a,min(b,c)))<<endl;
	return 0;
}